...
public class TestLocationDAO {
	...
	public void setUp() throws DAOException {
		...
		this.location1 = new Location(Date.valueOf("2023-06-23"),"Non",36,400.0f,100.0f,200.0f,"testBien001","mary123",true);
		this.location2 = new Location(Date.valueOf("2023-06-23"),"Non",36,100.0f,20.0f,50.0f,"testBien002","mary123",true);
		this.location3 = new Location(Date.valueOf("2024-01-25"),"Non",40,500.0f,150.0f,200.0f,"testBien003","johnnyboy",true);
